<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      <p class="text-teal-200">Hello World, I'm</p>
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Febryan Riyadi</h1>
      <div class="py-2">
        <h1
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
        class="w-10/12 md:h-auto rounded-full border-4 border-teal-200 pict" src="https://i1.sndcdn.com/avatars-000214125831-5q6tdw-t500x500.jpg">
    </div>
  </main>
</template>
...
export default {
  ...
  data() {
    return {
      toRotate: ["Web Designer", "Software Engineer", "Web Developer", "Computer Science Student"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
...
.pict {
  box-shadow: 0px 0px 73px -9px rgba(112, 255, 200, 0.44);
-webkit-box-shadow: 0px 0px 73px -9px rgba(112, 255, 200, 0.44);
-moz-box-shadow: 0px 0px 73px -9px rgba(112, 255, 200, 0.44);
}
